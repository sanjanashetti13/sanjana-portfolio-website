export const profile = {
  ...
  aboutPhotoUrl: "/avatar/sanjana.png?v=2",
};
...
export const projects: Project[] = [
  ...
  {
    slug: "semiconductor-intelligence-platform",
    section: "production",
    typeBadge: "Data Engineering",
    typeLabel: "Azure · Lakehouse · Power BI · AI SQL Agent",
    filters: ["Data Engineering", "AI", "Full Stack"],
    category: "Data Engineering",
    tag: "Data Engineering",
    title: "Semiconductor Intelligence & Analytics Platform",
    description:
      "End-to-end Azure data engineering and AI analytics platform for semiconductor manufacturing data. Takes raw manufacturing/SQL data through ETL into a Bronze → Silver → Gold Lakehouse on Delta Lake, serves curated data via Azure SQL and Power BI, and layers an AI SQL Agent so users can ask natural-language questions, inspect generated SQL, and get SQL-driven insights — with the full stack deployed on Azure App Service via GitHub Actions CI/CD and OIDC auth.",
    cardDescription:
      "Azure Lakehouse (Bronze–Silver–Gold) + Power BI + AI SQL Agent for NL analytics.",
    highlights: [
      "Implemented a Bronze → Silver → Gold medallion Lakehouse with Delta Lake and ETL pipelines for semiconductor manufacturing data",
      "Built Power BI dashboards for manufacturing KPIs, wafer pass/fail, yield, and sensor-related insights on curated Azure SQL data",
      "Developed an AI SQL Agent that generates, executes, and exposes SQL from natural-language questions against Azure SQL",
      "Deployed the full-stack app on Azure App Service with GitHub Actions CI/CD and OIDC federated credentials — secrets kept in App Service config",
    ],
    highlightPills: [
      { label: "Azure", variant: "accent" },
      { label: "Delta Lake" },
      { label: "Lakehouse" },
      { label: "Power BI" },
      { label: "AI SQL Agent" },
    ...
    highlightNote:
      "Shows Data Engineering → Lakehouse → BI → AI → Cloud → DevOps in one platform — not just an AI chatbot.",
    stack: [
      "Azure",
      "Delta Lake",
      "Lakehouse",
    ...
    featured: true,
    problem:
      "Semiconductor manufacturing data needs progressive cleaning and curation before it is useful for yield, wafer, and sensor analytics — and business users still need a way to ask questions without writing SQL by hand.",
    solution:
      "Built an Azure ETL + Delta Lakehouse pipeline (Bronze/Silver/Gold), loaded curated data into Azure SQL for Power BI KPIs, and connected an AI SQL Agent (React + FastAPI) that turns natural language into executable SQL with query transparency, then deployed the platform on Azure App Service with GitHub Actions and OIDC.",
    impact:
      "Delivered a reusable path from raw manufacturing data to BI dashboards and natural-language insights — demonstrating end-to-end data engineering, warehousing, analytics, AI, cloud, and DevOps in one system.",
    challenges:
      "Keeping medallion layers honest (raw → cleaned → curated) while wiring an AI agent that can safely generate and run SQL against Azure SQL required careful schema design and secret handling. Configuring GitHub OIDC federated credentials avoided storing Azure passwords in CI while still enabling automated deploys.",
    learnings:
      "Learned to position AI as a layer on top of solid data engineering — Lakehouse + Azure SQL + Power BI first, then NL-to-SQL — and to ship the platform with production-minded CI/CD and secret management.",
    timeline: "2026",
    screenshots: [],
  },
  {
